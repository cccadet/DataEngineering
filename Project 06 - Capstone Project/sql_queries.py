...
data_quality_unique_state = ("""
SELECT case when count(*) = count(distinct state_id) then 'OK' else 'ERROR' end 
FROM state
""")

data_quality_coronavirus_null_city_id = ("""
SELECT case when count(*) > 0 then 'ERROR' else 'OK' end 
